class KCMConstants:
    ...
    CENTRAL_BASE_LINES = [
        ...
        62, 63, 64, 70, 71, 73, 76, 106, 113, 120, 121, 122,
        123, 124, 125, 128, 131, 132, 214, 303, 355
    ]

    NORTH_BASE_LINES = [
        31, 32, 41, 65, 67, 74, 75, 77, 78, 167,
        301, 304, 308, 309,
        312, 316, 330, 331, 342, 345, 346, 347, 348,
        372, 373
    ]

    EAST_BASE_LINES = [
        114, 200, 201, 204, 208, 212, 216, 217, 218, 219,
        221, 224, 226,
    ...
    SOUTH_BASE_LINES = [
        50, 101, 102, 105, 107, 111, 116, 118, 119,
    ...
    CENTRAL_BASE_LINE_INDICATOR = 'c'
    NORTH_BASE_LINE_INDICATOR = 'n'
    EAST_BASE_LINE_INDICATOR = 'e'
    SOUTH_BASE_LINE_INDICATOR = 's'
    ...
    REGULAR_LINES = [
        ...
        13, 14, 24, 26, 27, 28, 33, 36, 40, 43, 44,
